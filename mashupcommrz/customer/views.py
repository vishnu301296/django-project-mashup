...
from customer.forms import RegistrationForm,LoginForm,CustomerCheckoutForm
from django.contrib.auth import authenticate,login,logout
from django.contrib.auth.decorators import login_required


from customer.models import Products
from customer.models import CustomerCart,CustomerCheckout
...
def checkoutcustomer(request):
    if request.method == 'POST':
        ...
        client = razorpay.Client(auth=("rzp_test_hFwhSFiJ4Q9gXx", "fi42f8Nf6y0uAf5P44tUKxQ1"))
        DATA = {
